...
class Player(GameObject):
    """The class representing the Player in the Galapagos game.
    ...
    def creatures(self) -> List['games.galapagos.creature.Creature']:
        """list[games.galapagos.creature.Creature]: Every creature owned by this Player.
        """
    ...
    @property
    def opponent(self) -> 'games.galapagos.player.Player':
        """games.galapagos.player.Player: This player's opponent in the game.
        """
    ...
    def total_health(self) -> int:
        """int: The combined health of all creatures this player had at the beginning of this turn.
        """
